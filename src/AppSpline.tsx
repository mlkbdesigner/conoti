...
const SPLINE_SCENE = 'https://prod.spline.design/C3Y5tTxgz1xBT56d/scene.splinecode';
...
function SplineHero() {
  ...
  return (
    ...
    >
      <div className="relative h-[550px] w-full sm:h-[650px] lg:h-[720px] overflow-hidden">
        {showFallback && (
        ...
        {canLoad && !failed && (
          <>
            ...
            <canvas
              ...
              style={{
                width: '100%',
                height: '100%', transform: 'scale(1.3)', transformOrigin: 'center center',
                opacity: loaded ? 1 : 0,
                    ...
                    <div className="flex flex-col justify-center h-full space-y-3">
                      {[
                        ...
                        <div key={i} className="flex items-center gap-3 rounded-xl border border-white/5 bg-white/[0.02] px-4 py-2.5">
                          ...
                          <span className="text-xs font-medium text-slate-300 flex-1">{item.name}</span>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
            ...
            <div className="grid gap-8 lg:grid-cols-2">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5 }}
                className="rounded-3xl border border-white/5 bg-white/[0.02] p-10 lg:p-12 relative overflow-hidden transition-all duration-300 hover:border-white/10 hover:bg-white/[0.04] hover:shadow-[0_0_30px_rgba(147,51,234,0.08)]"
              >
                ...
                <div className="relative z-10">
                  <p className="text-xs font-bold text-slate-600 uppercase tracking-widest mb-12">Números que falam por si</p>
                  <div className="grid grid-cols-2 gap-12">
                    {[
                      { label: "Redução de CPA", value: "66%", color: "text-purple-400" },
                      { label: "Aumento de CTR", value: "9x", color: "text-blue-400" },
                      { label: "Vendas Geradas", value: "$500M+", color: "text-emerald-400" },
                      { label: "Marcas Escaladas", value: "200+", color: "text-orange-400" }
                    ].map((stat, i) => (
                      <motion.div
                        key={i}
                        initial={{ opacity: 0, y: 10 }}
                        ...
                        className="space-y-2"
                      >
                        <p className={`font-heading text-4xl lg:text-5xl font-bold ${stat.color}`}>{stat.value}</p>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                {[
                  ...
                  {
                    name: "Marcos Lima",
                    role: "Founder @ GadgetStore",
                    text: "De 10k para 100k/mês em apenas 45 dias com a estratégia deles.",
                    seed: "marcos"
                  },
                  {
                    name: "Julia Costa",
                    role: "Head of Growth @ BeautyCo",
                    text: "O suporte e a análise de dados são diferenciais absurdos no mercado.",
                    seed: "julia"
                  }
                ].map((testimonial, i) => (
                  <motion.figure
                    ...
                    className="rounded-2xl border border-white/5 bg-white/[0.02] p-6 flex flex-col justify-between transition-all duration-300 hover:border-white/10 hover:bg-white/[0.04] hover:shadow-[0_0_30px_rgba(147,51,234,0.08)]"
                  >
                    <blockquote>
